...
- **Virtual file tree** — The path hierarchy presented by `td ls`, `td tree`, `td cp`, `td get`, etc. It is reconstructed from Telegram media, `td:v1` / `td-manifest:v1` / `td-album:v1` records, then cached in SQLite.
